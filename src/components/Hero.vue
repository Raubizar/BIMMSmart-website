        ...
        <v-row class="align-center justify-center text-center">
          <v-col cols="12" class="pb-8">
            ...
            <ul style="list-style: none; padding-left: 0; margin-bottom: 2rem;">
              <li v-for="(point, i) in content.bullets" :key="i" class="d-flex align-center mb-2">
                <v-icon :color="theme.headlineColor" size="20" class="me-3">mdi-check-circle</v-icon>
                <TextParagraph
                  :color="theme.paragraphColor"
                  size="subtitle-1"
                  spacing="mb-0"
            ...
            <div class="hero-content">
              ...
              <ul style="list-style: none; padding-left: 0; margin-bottom: 3rem;">
                <li v-for="(point, i) in content.bullets" :key="i" class="d-flex align-center mb-3">
                  <v-icon :color="theme.headlineColor" size="24" class="me-3">mdi-check-circle</v-icon>
                  <TextParagraph
                    :color="theme.paragraphColor"
                    size="h6"
                    spacing="mb-0"
